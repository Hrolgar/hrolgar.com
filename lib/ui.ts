...
const STRINGS = {
  en: {
    ...
    nextStep: "Next step",
    serviceCtaHeading: "Interested in this service?",
    serviceCtaDescription: "Let\u2019s discuss your project, the constraints you\u2019re working with, and what a practical delivery plan could look like.",
    serviceCtaButton: "Start a conversation",
    fullProjectForm: "Bigger project? Use the full project form, with budget and timeline",
    languageHint: "This page is also available in English",
    minRead: "min read",
    navigate: "Navigate",
  ...
  nb: {
    ...
    backToServices: "Tilbake til tjenester",
    serviceLabel: "Tjeneste",
    serviceByline: "frilans fra Ålesund",
    caseStudies: "Kundecaser",
    nextStep: "Neste steg",
    serviceCtaHeading: "Interessert i denne tjenesten?",
    serviceCtaDescription: "Fortell meg om prosjektet, hvilke begrensninger du jobber innenfor, og hva en realistisk leveranseplan kan se ut som.",
    serviceCtaButton: "Ta kontakt",
    fullProjectForm: "Større prosjekt? Bruk det fulle skjemaet, med budsjett og tidsramme",
    languageHint: "Denne siden finnes også på norsk",
    minRead: "min lesing",
    navigate: "Meny",
