    ...
    <footer className="border-t border-border px-6 py-12">
      <div className="max-w-5xl mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-4">
        ...
        <nav aria-label="Footer navigation" className="md:col-span-1">
          <p className="text-xs font-semibold uppercase tracking-[0.24em] text-muted">{t("navigate", locale)}</p>
        ...
        <nav aria-label={t("featuredServices", locale)}>
          <p className="text-xs font-semibold uppercase tracking-[0.24em] text-muted">{t("featuredServices", locale)}</p>
          <div className="mt-4 grid gap-6 sm:grid-cols-2 md:grid-cols-1">
            <div>
              <p className="mb-3 text-xs font-semibold uppercase tracking-[0.18em] text-muted">{t("servicesLabel", locale)}</p>
        ...
        {socials.length > 0 && (
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.24em] text-muted">{t("social", locale)}</p>
