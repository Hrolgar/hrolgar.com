...
const serviceLinks = [
  { label: "API & Integration Development", href: "/services/api-integration" },
  { label: "Backend Systems & .NET", href: "/services/backend-dotnet" },
  { label: "Infrastructure & Automation", href: "/services/infrastructure-automation" },
];

const projectLinks = [
  { label: "Email Infrastructure — High-Concurrency Self-Hosted MTA", href: "/projects/email-infrastructure-mta" },
  { label: "Refinarr", href: "/projects/refinarr" },
  { label: "Hrolbot", href: "/projects/hrolbot" },
];
...
export default function Footer({ contact, footerTagline, siteName, navItems, showBlog }: Props) {
  ...
  return (
    <footer className="border-t border-border px-6 py-12">
      <div className="max-w-5xl mx-auto grid gap-8 md:grid-cols-[minmax(0,1.2fr)_minmax(160px,0.75fr)_minmax(200px,1fr)_minmax(160px,0.75fr)]">
        <div>
          <a
            href="/"
        ...
        <nav aria-label="Footer navigation" className="md:col-span-1">
          ...
          <div className="mt-4 flex gap-12">
            {[navLinks.slice(0, 4), navLinks.slice(4)].filter(col => col.length > 0).map((col, i) => (
        ...
        <nav aria-label="Featured services and projects">
          <p className="text-xs font-semibold uppercase tracking-[0.24em] text-muted">Featured</p>
          <div className="mt-4 grid gap-6 sm:grid-cols-2 md:grid-cols-1">
            {[
              { heading: "Services", links: serviceLinks },
              { heading: "Projects", links: projectLinks },
            ].map((section) => (
              <div key={section.heading}>
                <p className="mb-3 text-xs font-semibold uppercase tracking-[0.18em] text-muted">{section.heading}</p>
        ...
        <p className="text-xs text-muted md:col-span-4 pt-6 border-t border-border">
